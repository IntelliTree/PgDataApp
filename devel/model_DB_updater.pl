#!/usr/bin/env perl
#
# File bootstrapped by RapidApp 1.3001
#
...
my $app_class   = 'PgDataApp';
my $model_class = 'PgDataApp::Model::DB';
...
if($from_ddl) { # from_ddl logic
  ...
  my $ddl = file($approot,'sql/pgdataapp.sql')->resolve;
...
=head1 NAME
model_DB_updater.pl - updater script for RapidDbic model 'PgDataApp::Model::DB'
